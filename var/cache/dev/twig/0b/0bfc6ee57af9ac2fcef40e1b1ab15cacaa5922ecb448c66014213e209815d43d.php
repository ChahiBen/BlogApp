...
class __TwigTemplate_119132646e822023309837b5e44876857ad8ce0d4b14829823ca4d28b490ef17 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return array (  96 => 15,  92 => 13,  89 => 12,  85 => 11,  81 => 10,  77 => 9,  73 => 8,  68 => 5,  58 => 4,  35 => 2,);
    }
...
{% block body %}
    ...
    <h1>Bienvenu dans la page d'inscription !</h1>
    {{ form_start(form) }}
    {{ form_row(form.username, {'label': \"Nom d'utilisateur\", 'attr': {'placeholder': \"Julien\"}}) }}
    {{ form_row(form.email, {'label': \"Adresse email\", 'attr': {'placeholder': \"xyz@exemple.com\"}}) }}
    {{ form_row(form.password, {'label': \"Mot de passe\", 'attr': {'placeholder': \"Mot de passe\"}}) }}
    {{ form_row(form.confirm_password, {'label': \"Confirmation du mot de passe\", 'attr': {'placeholder': \"Confirmez
    votre mot de passe\"}}) }}
    <button type=\"submit\" class=\"btn btn-success\">Inscription</button>
    {{ form_end(form) }}
