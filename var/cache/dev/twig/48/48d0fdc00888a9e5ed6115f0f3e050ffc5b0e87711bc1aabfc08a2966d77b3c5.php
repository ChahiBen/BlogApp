...
class __TwigTemplate_8bc7a1a1571ffd5aba21214537efd1464ad1a2b356f8e94132624963b73eb4f6 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["article"]) {
            ...
            echo " dans la catégorie actualité</div>
                <div class=\"content\">
                    <img src=\"";
            // line 12
            ...
            echo "
                    <a href=\"";
            // line 14
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("blog_show", ["slug" => twig_get_attribute($this->env, $this->source, $context["article"], "slug", [], "any", false, false, false, 14)]), "html", null, true);
...
";
    ...
    {
        return array (  127 => 18,  117 => 14,  113 => 13,  109 => 12,  102 => 10,  98 => 9,  95 => 8,  91 => 7,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block body %}
    <section class=\"articles\">
        {% for article in articles %}
            <article>
                <h2>{{ article.title }}</h2>
                <div class=\"metadata\">Ecrit le {{ article.createdAt|date('d/m/Y') }} à {{ article.createdAt|date('H:i') }} dans la catégorie actualité</div>
                <div class=\"content\">
                    <img src=\"{{ article.image }}\" alt=\"\">
                    {{ article.content|raw }}
                    <a href=\"{{ path('blog_show', {'slug': article.slug}) }}\" class=\"btn btn-primary\">lire la suite</a>
                </div>
            </article>
        {% endfor %}
    </section>
